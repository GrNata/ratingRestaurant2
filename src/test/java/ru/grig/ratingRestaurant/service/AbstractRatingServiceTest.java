...
import ru.grig.ratingRestaurant.repository.JpaUtil;
import ru.grig.ratingRestaurant.repository.RatingRepository;
import ru.grig.ratingRestaurant.repository.datajpa.CrudRatingRepository;
import ru.grig.ratingRestaurant.repository.jpa.JpaRatingRepository;
...
//    @Autowired
//    JpaRatingRepository repository;
...
//        if (environment.acceptsProfiles(Profiles.of(DATAJPA, JPA))) {
...
//        assertFalse(repository.delete(RATING_ID));
        assertThrows(NotFoundException.class, () -> service.delete(RATING_ID));
    }
